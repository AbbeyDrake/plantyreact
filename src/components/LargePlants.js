export const LARGEPLANTS = [
  {
    ...
    featured: false,
    description:
      "Though it is typically kept as a house plant, monsteras also produce fruit that tastes like a combination of a banana and a pineapple.",
  ...
  },
  {
    ...
    featured: false,
    description:
      "Other common names for the Areca Palm are 'golden cane palm' and 'butterfly palm'. They can grow up to 8ft tall.",
